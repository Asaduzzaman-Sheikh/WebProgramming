...
export default function OAuth() {
  ...
  const handleGoogleClick = async () => {
    try {
      ...
      // Optional: log the Google user object
      ...
      if (!res.ok) {
        ...
        throw new Error(`Google login failed: ${errMessage}`);
      }
  ...
  return (
    <button
      ...
      className="
        ...
        shadow-sm text-gray-800 font-semibold text-sm sm:text-base 
        transition-all duration-300 ease-in-out 
        hover:shadow-lg hover:bg-gray-50 hover:-translate-y-1 
