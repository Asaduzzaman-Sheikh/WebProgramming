        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div className="relative">
            ...
            <input
              ...
              placeholder="Email"
              className="w-full pl-10 pr-4 py-2 border-2 border-slate-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 border-2 border-slate-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            />
            <span
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full bg-gradient-to-r from-indigo-600 to-indigo-800 text-white py-2 rounded-lg font-semibold shadow-md transition duration-300 ${
